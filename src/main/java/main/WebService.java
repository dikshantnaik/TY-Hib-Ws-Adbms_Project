...
public class WebService {
    ...
    public static HttpResponse<String> postApiCall(String EndPoint, String Body)
	...
	String Url = SERVER_URL+EndPoint;
	 try {
	    HttpResponse<JsonNode> jsonResponse 
	          = Unirest.get(Url).header("authorization", SERVER_TOKEN)
	          .header("accept", "application/json").queryString(parameters)
	          .asJson();
	    return jsonResponse;
